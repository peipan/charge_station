...
"QToolBar{spacing:160px;}")
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("UI/image/数据导出.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.act_output.setIcon(icon10)
        font = QtGui.QFont()
        font.setPointSize(13)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("UI/image/地图.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.act_map.setIcon(icon9)
        font = QtGui.QFont()
        font.setPointSize(13)
