...
"QToolBar{spacing:160px;}")
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("UI/image/数据导出.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("UI/image/地图.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
