...
class Ui_ParametersWindow(object):
    def setupUi(self, ParametersWindow):
        ...
        self.check_operator = QtWidgets.QCheckBox(self.splitter)
        self.check_operator.setStyleSheet("font: 75 12pt \"微软雅黑\";")
        self.check_operator.setObjectName("check_operator")
        self.check_temp = QtWidgets.QCheckBox(self.splitter)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.check_temp.sizePolicy().hasHeightForWidth())
        self.check_temp.setSizePolicy(sizePolicy)
        self.check_temp.setStyleSheet("font: 75 12pt \"微软雅黑\";")
        self.check_temp.setObjectName("check_temp")
        self.check_frequency = QtWidgets.QCheckBox(self.splitter)
        self.check_frequency.setStyleSheet("font: 75 12pt \"微软雅黑\";")
        self.check_frequency.setObjectName("check_frequency")
        self.check_factory = QtWidgets.QCheckBox(self.splitter)
        self.check_factory.setStyleSheet("font: 75 12pt \"微软雅黑\";")
        self.check_factory.setObjectName("check_factory")
        self.check_time = QtWidgets.QCheckBox(self.splitter)
        ...
        self.btn_confirm_choose.setMaximumSize(QtCore.QSize(120, 39))
...
"font: 75 12pt \"微软雅黑\";")
        ...
        spacerItem6 = QtWidgets.QSpacerItem(478, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        spacerItem10 = QtWidgets.QSpacerItem(438, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
...
"font: 75 12pt \"微软雅黑\";")
        ...
        spacerItem13 = QtWidgets.QSpacerItem(20, 60, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
    ...
    def retranslateUi(self, ParametersWindow):
        ...
        self.check_operator.setText(_translate("ParametersWindow", "运营商"))
        self.check_temp.setText(_translate("ParametersWindow", "环境温度"))
        self.check_frequency.setText(_translate("ParametersWindow", "使用频率"))
        self.check_factory.setText(_translate("ParametersWindow", "生产厂家"))
