...
class Ui_ParametersWindow(object):
    def setupUi(self, ParametersWindow):
        ...
        ParametersWindow.resize(1209, 607)
        self.formLayout = QtWidgets.QFormLayout(ParametersWindow)
        ...
        spacerItem1 = QtWidgets.QSpacerItem(929, 133, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        ...
        self.splitter = QtWidgets.QSplitter(ParametersWindow)
        ...
        self.label_25.setMinimumSize(QtCore.QSize(75, 75))
        self.label_25.setMaximumSize(QtCore.QSize(75, 75))
        self.label_25.setStyleSheet("image: url(:/image/main_title.png);")
        self.label_25.setAlignment(QtCore.Qt.AlignCenter)
        self.label_25.setObjectName("label_25")
        self.gridLayout_2.addWidget(self.label_25, 0, 0, 1, 1)
        self.label_26 = QtWidgets.QLabel(self.layoutWidget_3)
        self.label_26.setMinimumSize(QtCore.QSize(750, 0))
        ...
        self.splitter_16 = QtWidgets.QSplitter(ParametersWindow)
        ...
        self.gridLayout.addWidget(self.splitter_16, 1, 0, 1, 1)
        ...
        self.btn_confirm_weight = QtWidgets.QPushButton(ParametersWindow)
        self.btn_confirm_weight.setMinimumSize(QtCore.QSize(120, 0))
        ...
        self.label_24 = QtWidgets.QLabel(ParametersWindow)
        self.label_24.setObjectName("label_24")
        self.gridLayout.addWidget(self.label_24, 4, 0, 1, 1)
        self.splitter_10 = QtWidgets.QSplitter(ParametersWindow)
        ...
        self.gridLayout.addWidget(self.splitter_10, 5, 0, 1, 1)
        ...
        self.btn_confirm_range = QtWidgets.QPushButton(ParametersWindow)
        self.btn_confirm_range.setMinimumSize(QtCore.QSize(120, 0))
        ...
        spacerItem5 = QtWidgets.QSpacerItem(478, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_2.addItem(spacerItem5)
        self.gridLayout.addLayout(self.horizontalLayout_2, 6, 0, 1, 1)
        self.label_12 = QtWidgets.QLabel(ParametersWindow)
        self.label_12.setObjectName("label_12")
        self.gridLayout.addWidget(self.label_12, 7, 0, 1, 1)
        self.label_13 = QtWidgets.QLabel(ParametersWindow)
        ...
        spacerItem6 = QtWidgets.QSpacerItem(929, 132, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.formLayout.setItem(2, QtWidgets.QFormLayout.FieldRole, spacerItem6)
    ...
    def retranslateUi(self, ParametersWindow):
        ...
        self.label_25.setText(_translate("ParametersWindow", "<html><head/><body><p><br/></p></body></html>"))
        self.label_26.setText(_translate("ParametersWindow", "<html><head/><body><p><span style=\" font-family:\'华文隶书\'; font-size:26pt; font-weight:600; color:#2684cb;\">北京市计量检测科学研究院</span></p></body></html>"))
        self.label_27.setText(_translate("ParametersWindow", "<html><head/><body><p align=\"center\"><span style=\" font-weight:600; color:#3e94c9;\">---------------------------------------------------------------------------------------------------------------------</span></p></body></html>"))
        self.label_23.setText(_translate("ParametersWindow", "<html><head/><body><p><span style=\" font-family:\'华文隶书\'; font-size:18pt; font-weight:600; color:#2684cb;\">参数权重设置________________________________________________________</span></p></body></html>"))
        self.label_16.setText(_translate("ParametersWindow", "安装时长权重"))
        ...
        self.label_24.setText(_translate("ParametersWindow", "<html><head/><body><p><span style=\" font-family:\'华文隶书\'; font-size:18pt; font-weight:600; color:#2684cb;\">风险范围设置__________________________________________________________</span></p></body></html>"))
